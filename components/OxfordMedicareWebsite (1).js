  ...
  return (
    <div className="bg-[#0A0F3C] text-white" style={{ fontFamily: 'Palatino Linotype, serif' }}>
      ...
      <section className="py-20 text-center">
        <h2 className="text-xl sm:text-2xl font-semibold text-[#A5CC50]">Your full homepage content goes here...</h2>
        <p className="text-white mt-4">You can paste the rest of your completed sections from the canvas below this line.</p>
      </section>
    </div>
  );
}
